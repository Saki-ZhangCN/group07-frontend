...
const routes = [
  ...
  // 讲师端路由
  {
    ...
    children: [
      ...
      { path: 'course/:id/edit', name: 'CourseEdit', component: () => import('../pages/teacher/CourseEdit.vue') },
  ...
  // 运营端路由
  {
    ...
    children: [
      ...
      { path: 'resources', name: 'ResourceManage', component: () => import('../pages/admin/ResourceManage.vue') },
